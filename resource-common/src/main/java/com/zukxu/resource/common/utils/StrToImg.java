...
public class StrToImg {
	 ...
	 */
	public static BufferedImage generateImg(String text) {
		if (text.length() > 4) {
	 ...
	 * @throws IOException
	 */
	public static void toFile(BufferedImage roundedImage, String fileName) throws IOException {
		//文件生成
	 ...
	 * @return
	 */
	public static InputStream toUpload(BufferedImage roundedImage) {
